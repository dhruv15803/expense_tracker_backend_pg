...
import { addIncome, addIncomeCategory, getAllIncomeCategories, getAllIncomes, getIncomeCategoryNameById } from './controllers/income.controller.js';
const {Client} = pkg;
dotenv.config({
    path:"./.env"
})
...
app.get('/income/getAllIncomeCategories',getAllIncomeCategories);
